...
export default function LibraryPage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <div className="py-24 pt-44 pb-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10">
          <h1 className="text-5xl md:text-6xl lg:text-[4.7rem] font-medium leading-[0.95] text-brand-dark tracking-tight text-center mb-4">
            ...
            <span className="relative inline-block px-1">
              <span className="relative z-20">Library<span className="absolute inset-0 bg-primary -z-10 rounded-lg transform -skew-x-3 scale-110 opacity-20"></span></span>
        ...
        {featuredTopic && (
          <div className="mb-12">
            <div className="relative mb-4">
              <p className="text-sm font-medium text-zinc-500 uppercase tracking-wider">Featured</p>
            </div>
