...
export default function CoursesPage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <div className="py-24 pt-44 pb-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <h1 className="text-5xl md:text-6xl lg:text-[4.7rem] font-medium leading-[0.95] text-brand-dark tracking-tight text-center mb-4">
            ...
            <span className="relative inline-block px-1">
              <span className="relative z-20 ">Perfect<span className="absolute inset-0 bg-primary -z-10 rounded-lg transform -skew-x-3 scale-110 opacity-20"></span></span>
          ...
          <div className="w-full max-w-3xl mx-auto">
            <div className="relative">
              <input
                ...
                className="w-full bg-white px-6 py-3 rounded-full border outline-none shadow-xs transition-colors"
              />
      ...
      {/* Main Content */}
      <div className="pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="mb-8 flex justify-between items-start">
          <div>
            <h2 className="text-3xl font-semibold text-gray-900 mb-2">
              {category === 'All' ? 'All Courses' : `${category} Courses`}
            </h2>
            <p className="text-lg text-gray-600 font-medium">{filteredCourses.length} courses available</p>
          </div>
